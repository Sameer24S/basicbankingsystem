...
<body>
    ...
    <table class="flat-table-1">
		...
		<tr>
			...
			<td>
				<form action="user.php" method="post"  class="view">
					<button class="button1" type="submit" name="name" value="Apurv">View</button>
				</form>
			</td>
		</tr>
		<tr>
        ...
        <tr>
			...
			<td>
				<form action="user.php" method="post" class="view">
					<button class="button1"type="submit" name="name" value="Omkar">View</button>
				</form>
			</td>
		</tr>
        <tr>
			...
			<td>
				<form action="user.php" method="post" class="view">
					<button class="button1"type="submit" name="name" value="Ashwin">View</button>
				</form>
			</td>
		</tr>
        <tr>
			...
			<td>
				<form action="user.php" method="post" class="view">
					<button class="button1"type="submit" name="name" value="Saurabh">View</button>
				</form>
			</td>
        </tr>
        <tr>
